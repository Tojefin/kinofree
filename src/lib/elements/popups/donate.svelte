<section class="info-popup" id="donate">
  <h2>Поддержать сайт</h2>
  <p>Arc <img height="32px" width="32px" src="https://arc.io/_nuxt/img/mock-widget.ec2f0aa.svg" style="top: 10px;"> - это сеть доставки контента, когда вы подключаетесь к ней, вы становитесь
